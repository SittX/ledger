                ...
                <div className="card-body space-y-6">
                    <div className="card-title">
                        ...
                        {accountData?.isPrimaryAccount && (
                            <span className="badge badge-outline badge-info">Primary Account</span>
                        )}
                    </div>
                    <div className="grid grid-cols-1 gap-y-6 lg:grid-cols-2">
                        ...
                        <div>
                            <h3 className="text-md text-base-content/50">Include In NetWorth</h3>
                            <p className="text-lg">{accountData?.includeInNetWorth ? 'true' : 'false'}</p>
                        </div>
                        ...
                        <div>
                            ...
                            {accountData?.isActive && <span className={`badge badge-success`}>Active</span>}
                            {!accountData?.isActive && <span className={`badge badge-disabled`}>Not Active</span>}
                        </div>
                    </div>
